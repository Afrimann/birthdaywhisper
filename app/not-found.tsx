  ...
  return (
    <div className="min-h-screen bg-canvas text-accent-900 flex flex-col items-center justify-center px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-md animate-fade-rise">
        ...
        {/* 404 */}
        <p className="font-fraunces text-[7rem] font-bold leading-none text-transparent bg-clip-text bg-gradient-to-b from-[rgba(212,83,126,0.6)] to-[rgba(212,83,126,0.1)] select-none mb-2">
          404
        </p>
